...
if __name__ == '__main__':
    ...
    ages, genders, sess, images_pl,train_mode = eval(aligned_image, model_path)

    age, gender = eval_(ages, genders, sess, aligned_image, model_path, images_pl, train_mode)
    
    print("xxxxxxxxx=============>", age, gender)
    draw_label(image, XY, age, gender, font_scale=font_scale, thickness=thickness)
